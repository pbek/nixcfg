...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    home-manager.users = lib.genAttrs hokage.usersWithRoot (_userName: {
      ...
      programs.starship = {
        enable = true;
        enableFishIntegration = false; # We manually initialize it below for interactive shells only
      ...
      # Initialize starship only for interactive shells
      programs.fish.interactiveShellInit = ''
        # Only initialize starship in interactive mode
