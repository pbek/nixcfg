# Backport Kate fixes and features.
...
# https://invent.kde.org/utilities/kate/-/merge_requests/2195
    ...
    _kfinal: kprev: {
      kate = kprev.kate.overrideAttrs (old: {
        patches = (old.patches or [ ]) ++ [
          ...
          ./kde/kate-git-forge-project-hook.patch
          ./kde/kate-git-forge-plugin.patch
        ];
      });
    }
  );
